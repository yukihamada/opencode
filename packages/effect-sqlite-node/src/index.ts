...
export const TypeId: TypeId = "~@sente-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@sente-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@sente-ai/effect-sqlite-node/NodeSqliteClient")
