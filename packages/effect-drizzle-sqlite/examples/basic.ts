...
class Database extends Context.Service<Database, DatabaseShape>()("@sente/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@sente/example/UserStore") {
