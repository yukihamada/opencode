import { Sente } from "@sente-ai/client/effect"
...
import { createEmbeddedRoutes } from "@sente-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Sente.create")(function* () {
  ...
  const client = yield* Sente.make({ baseUrl: "http://opencode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@sente-ai/sdk-next/Sente") {}
