export const dict = {
  ...
  "enterprise.title": "OpenCode Enterprise — AI coding that never sends your code outside",
  "enterprise.meta.description":
    "OpenCode Enterprise keeps your source code inside your own infrastructure. SSO, audit logs, and self-hosted deployment for security-conscious engineering teams.",
  "enterprise.hero.title": "Your code never leaves your walls.",
  "enterprise.hero.body1":
    "GitHub Copilot and other cloud AI tools send your source code to third-party servers — a non-starter for finance, healthcare, and regulated industries. OpenCode runs entirely inside your infrastructure. No code is stored, transmitted, or used for training. Ever.",
  "enterprise.hero.body2":
    "Deploy in minutes with your existing SSO. Connect your internal LLM gateway. Get full audit logs. Tell us what you need.",
  "enterprise.hero.trust1": "Code never stored or transmitted",
  "enterprise.hero.trust2": "SSO / SAML ready",
  "enterprise.hero.trust3": "Self-hosted or VPC deployment",
  "enterprise.hero.trust4": "Full audit logs",
  "enterprise.hero.trust5": "Open source — fork and own it",
  "enterprise.hero.trust6": "Connect your own LLM gateway",
  "enterprise.form.name.label": "Full name",
  "enterprise.form.name.placeholder": "Jane Smith",
  "enterprise.form.role.label": "Role",
  "enterprise.form.role.placeholder": "CTO / VP Engineering",
  "enterprise.form.company.label": "Company",
  "enterprise.form.company.placeholder": "Acme Corp",
  "enterprise.form.email.label": "Work email",
  "enterprise.form.email.placeholder": "jane@acme.com",
  "enterprise.form.phone.label": "Phone (optional)",
  "enterprise.form.phone.placeholder": "+1 234 567 8900",
  "enterprise.form.message.label": "What's your biggest concern about AI coding tools today?",
  "enterprise.form.message.placeholder": "e.g. Our security team won't allow code to leave our VPC...",
  "enterprise.form.send": "Request a demo",
  "enterprise.form.sending": "Sending...",
  "enterprise.form.success": "Got it — we'll reach out within one business day.",
  ...
  "enterprise.faq.q1": "How is this different from GitHub Copilot or Cursor?",
  "enterprise.faq.a1":
    "Copilot, Cursor, and most AI coding tools send your code to their cloud servers for processing. OpenCode runs locally on each developer's machine and connects directly to your own AI provider or internal LLM gateway. Nothing passes through OpenCode's servers. You stay in full control.",
  "enterprise.faq.q2": "Can we use our own LLM (on-prem or private cloud)?",
  "enterprise.faq.a2":
    "Yes. OpenCode supports any OpenAI-compatible API endpoint. Point it at your internal Azure OpenAI, Bedrock, or self-hosted model and it works out of the box. If you have your own LLM gateway, we do not charge for tokens.",
  "enterprise.faq.q3": "How does pricing work?",
  "enterprise.faq.a3":
    "Per-seat annual licensing, minimum 10 seats. Volume discounts at 50, 200, and 500+ seats. Contact us for a custom quote — most teams get a proposal within 24 hours.",
  "enterprise.faq.q4": "What does the security team need to approve this?",
  "enterprise.faq.a4":
    "OpenCode is open source — your team can audit every line of code. We provide a SOC 2 Type 2 report, subprocessor list, and security questionnaire responses under NDA. Central config enforces which models and providers are allowed across your organization.",
  "enterprise.faq.q5": "How long does deployment take?",
  "enterprise.faq.a5.before":
    "Most teams are running in under a day. We provide a docker-compose self-hosted package and a step-by-step SSO integration guide. Visit",
  "enterprise.faq.a5.after": "for security docs, or contact us for a guided onboarding call.",
