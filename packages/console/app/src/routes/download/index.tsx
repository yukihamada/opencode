      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://teai.io/sente/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>teai.io/sente/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g sente-ai")}>
                <code>
                  npm i -g <strong>sente-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g sente-ai")}>
                <code>
                  bun add -g <strong>sente-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/sente")}>
                <code>
                  brew install <strong>anomalyco/tap/sente</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S sente")}>
                <code>
                  paru -S <strong>sente</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask sente-desktop")}>
                <code>
                  brew install --cask <strong>sente-desktop</strong>
                </code>
                <CopyStatus />
              </button>
