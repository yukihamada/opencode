...
import compareVideo from "../../asset/lander/sente-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/sente-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="sente:auth" content={loggedin() ? "true" : "false"} />
