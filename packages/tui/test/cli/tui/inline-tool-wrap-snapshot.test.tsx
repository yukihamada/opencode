...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "SENTE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/sente/src (151 matches)',
  },
  {
    icon: "✱",
  ...
  },
  {
    icon: "✱",
    label:
      'Grep "export const SENTE_DB|SENTE_DB|SENTE_DEV|Global\\.Path\\.data|data =" in packages/sente/src (115 matches)',
  },
] as const
