...
import defaultSoundPath from "@sente-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@sente-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@sente-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@sente-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@sente-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@sente-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "sente"
const DEFAULT_PACK_ID = "sente.default"
