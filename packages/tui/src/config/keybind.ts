...
export const Definitions = {
  ...
  help_show: keybind("shift+f1", "Open help dialog"),
  ...
  koe_toggle: keybind("f1", "Toggle Sente voice (KOE) on or off"),
...
export const CommandMap = {
  ...
  status_view: "sente.status",
  debug_view: "sente.debug",
