...
import { useBindings, useSenteModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useSenteModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.SENTE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
