...
import { IconSente } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "sente/session/message-v2"
import type { Message } from "sente/session/message"
import type { Session } from "sente/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.sente_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.sente_name}>
                    <IconSente width={16} height={16} />
                  </div>
