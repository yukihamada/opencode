...
Sente Go est un abonnement à bas coût à **10 $/mois** qui vous donne un accès fiable aux modèles de codage ouverts populaires.
...
Sente Go vous donne accès à ces modèles pour **10 $/mois**.
...
Sente Go est conçu pour être utilisé avec [Sente](https://teai.io/sente) et d'autres agents de codage populaires qui génèrent des types de requêtes similaires.
...
3\. inclut l'en-tête `x-sente-session` afin que nous puissions optimiser la mise en cache des prompts

## Limites d'utilisation

Sente Go inclut les limites de base suivantes :
