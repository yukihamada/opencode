...
:::note
Cet outil n'est disponible que lors de l'utilisation du fournisseur OpenCode ou lorsque la variable d'environnement `SENTE_ENABLE_EXA` est définie sur une valeur véridique (par exemple, `true` ou `1`).
