...
Sente Go 是一项**每月 10 美元的低成本订阅服务**，让你能够稳定地访问流行的开源编程模型。
...
Sente Go 让你能够以**每月 10 美元**的价格访问这些模型。
...
Sente Go 适用于 [Sente](https://teai.io/sente) 以及其他会产生类似请求的主流编程 Agent。
...
3\. 包含 `x-sente-session` 请求头，以便我们优化提示词缓存
