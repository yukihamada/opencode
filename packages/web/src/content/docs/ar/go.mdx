...
Sente Go هو اشتراك منخفض التكلفة بقيمة **$10/شهريًا** يمنحك وصولًا موثوقًا إلى نماذج البرمجة المفتوحة الشائعة.
...
يمنحك Sente Go الوصول إلى هذه النماذج مقابل **$10/شهريًا**.
...
صُمّم Sente Go للاستخدام مع [Sente](https://teai.io/sente) وغيره من وكلاء البرمجة الشائعين الذين ينشئون أنواعًا مماثلة من الطلبات.
...
3\. تتضمن ترويسة `x-sente-session` حتى نتمكن من تحسين التخزين المؤقت للمطالبات

## حدود الاستخدام

يتضمن Sente Go الحدود الأساسية التالية:
