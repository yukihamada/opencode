...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في sente.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في sente مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.sente/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/sente/tools/`.
