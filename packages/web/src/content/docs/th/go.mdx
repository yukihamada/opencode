...
Sente Go คือการสมัครสมาชิกในราคาประหยัด **$10/เดือน** ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร
...
Sente Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$10/เดือน**
...
Sente Go ออกแบบมาเพื่อใช้กับ [Sente](https://teai.io/sente) และเอเจนต์เขียนโค้ดยอดนิยมอื่นๆ ที่สร้างคำขอในลักษณะเดียวกัน
...
3\. มีส่วนหัว `x-sente-session` เพื่อให้เราสามารถปรับการแคชพรอมต์ให้เหมาะสมได้

## Usage limits

Sente Go มีขีดจำกัดพื้นฐานดังต่อไปนี้:
