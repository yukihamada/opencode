...
Sente Go is a low cost **$10/month subscription** that gives you reliable access to popular open coding models.
...
Sente Go gives you access to these models for **$10/month**.
...
Sente Go is designed to be used with [Sente](https://teai.io/sente) and other
...
3\. includes the `x-sente-session` header so we can optimize prompt caching

## Usage limits

Sente Go includes the following base limits:
