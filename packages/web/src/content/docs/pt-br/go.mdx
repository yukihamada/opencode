...
O Sente Go é uma assinatura de baixo custo de **US$ 10/mês** que oferece acesso confiável a modelos abertos de programação populares.
...
O Sente Go lhe dá acesso a esses modelos por **US$ 10/mês**.
...
O Sente Go foi projetado para ser usado com o [Sente](https://teai.io/sente) e outros agentes de programação populares que geram tipos de requisições semelhantes.
...
3\. inclui o header `x-sente-session` para que possamos otimizar o cache de prompts

## Limites de uso

O Sente Go inclui os seguintes limites base:
