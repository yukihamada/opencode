...
Możesz zdefiniować polecenia w `sente.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji sente:
...
- Globalnie: `~/.config/sente/commands/`
- Na projekt: `.sente/commands/`
...
sente zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
