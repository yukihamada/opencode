---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala sente.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

sente zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie sente uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI sente, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do sente. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `sente.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Sente czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `sente.default`.
