...
Sente Go 是一項**每月 $10 美元的低成本訂閱服務**，讓您能穩定使用受歡迎的開源寫程式模型。
...
Sente Go 讓您可以用**每月 $10 美元**存取這些模型。
...
Sente Go 適用於 [Sente](https://teai.io/sente) 以及其他會產生類似請求的主流程式設計 Agent。
...
3\. 包含 `x-sente-session` 請求標頭，以便我們最佳化提示詞快取
