...
Sente Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.
...
Sente Go gir deg tilgang til disse modellene for **$10/måned**.
...
Sente Go er utviklet for bruk med [Sente](https://teai.io/sente) og andre populære kodeagenter som genererer lignende typer forespørsler.
...
3\. inkluderer `x-sente-session`-headeren, slik at vi kan optimalisere promptbufring

## Bruksgrenser

Sente Go inkluderer følgende basisgrenser:
