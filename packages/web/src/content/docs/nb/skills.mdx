...
Agentferdigheter lar Sente oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går sente opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
sente viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `sente.json`:
