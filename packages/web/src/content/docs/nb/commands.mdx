...
Opprett `.sente/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Sente-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Sente [config](/docs/config):
...
Sente inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
