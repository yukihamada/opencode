...
:::note
Dette verktøyet er bare tilgjengelig når du bruker OpenCode-leverandøren eller når miljøvariabelen `SENTE_ENABLE_EXA` er satt til en sann verdi (f.eks. `true` eller `1`).
