---
title: TUI
description: Bruke sente-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sente gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Sente starter TUI for gjeldende katalog.
...
Når du bruker Sente TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Sente. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Sente. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `sente.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Sente venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `sente.default`.
