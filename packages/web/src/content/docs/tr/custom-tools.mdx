---
title: Özel Araçlar
description: LLM'un sente'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. sente'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.sente/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/sente/tools/` içine yerleştirerek.
