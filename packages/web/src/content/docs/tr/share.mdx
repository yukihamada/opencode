---
title: Paylasim
description: sente konusmalarini genel baglantilarla paylasin.
---

sente'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda sente:
...
sente, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak sente manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `sente.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda sente kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
