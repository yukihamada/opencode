...
Sente Go ist ein kostengünstiges Abonnement für **10 $/Monat**, das dir zuverlässigen Zugriff auf beliebte offene Coding-Modelle bietet.
...
Sente Go bietet dir Zugriff auf diese Modelle für **10 $/Monat**.
...
Sente Go wurde für die Verwendung mit [Sente](https://teai.io/sente) und anderen beliebten Coding-Agenten entwickelt, die ähnliche Arten von Anfragen erzeugen.
...
3\. den Header `x-sente-session` enthält, damit wir das Prompt-Caching optimieren können

## Nutzungslimits

Sente Go beinhaltet die folgenden Basislimits:
