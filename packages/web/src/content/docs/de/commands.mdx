...
Erstellen Sie `.sente/commands/test.md`:

```md title=".sente/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Sente-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Sente [config](/docs/config):

```json title="sente.jsonc" {4-12}
{
...
- Global: `~/.config/sente/commands/`
- Pro Projekt: `.sente/commands/`

```markdown title="~/.config/sente/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".sente/commands/component.md"
---
...
```md title=".sente/commands/create-file.md"
---
...
```md title=".sente/commands/analyze-coverage.md"
---
...
```md title=".sente/commands/review-changes.md"
---
...
```md title=".sente/commands/review-component.md"
---
...
Sente enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
