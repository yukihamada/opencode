---
title: Teilen
description: Teile Sente-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Sente-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Sente Folgendes:
...
Sente hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Sente den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`sente.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du sente in deiner Organisation einsetzt.
