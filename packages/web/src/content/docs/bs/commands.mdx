...
Kreiraj `.sente/commands/test.md`:
...
Možete dodati prilagođene komande kroz Sente konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Sente [config](/docs/config):
...
- Globalno: `~/.config/sente/commands/`
- Po projektu: `.sente/commands/`
...
Sente uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
