---
title: TUI
description: Korištenje korisničkog interfejsa Sente terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Sente pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Sente pokreće TUI za trenutni direktorij.
...
Kada koristite Sente TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Sente. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Sente. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `sente.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Sente čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `sente.default`.
