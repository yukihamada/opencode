...
Sente Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.
...
Sente Go vam daje pristup ovim modelima za **$10/mjesečno**.
...
Sente Go je osmišljen za korištenje s [Sente-om](https://teai.io/sente) i drugim popularnim agentima za programiranje koji generišu slične vrste zahtjeva.
...
3\. uključuje zaglavlje `x-sente-session` kako bismo mogli optimizovati keširanje promptova

## Ograničenja upotrebe

Sente Go uključuje sljedeća osnovna ograničenja:
