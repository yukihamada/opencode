...
Puede agregar comandos personalizados a través de la configuración Sente o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Sente [config](/docs/config):
...
sente incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
