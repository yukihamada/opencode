---
title: Deling
description: Del dine Sente-samtaler.
---

Sentes delingsfunksjon lar deg lage offentlige lenker til dine Sente-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Sente støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Sente manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `sente.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av sente i organisasjonen din.
