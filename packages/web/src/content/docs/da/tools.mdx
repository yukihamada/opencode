...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenCode-leverandøren eller når miljøvariabelen `SENTE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
