...
:::note
Questo strumento e' disponibile solo quando usi il provider OpenCode o quando la variabile d'ambiente `SENTE_ENABLE_EXA` e' impostata a un valore truthy (ad esempio `true` o `1`).
