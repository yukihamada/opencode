...
Puoi aggiungere comandi personalizzati tramite la config di Sente o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Sente:
...
- Globale: `~/.config/sente/commands/`
- Per progetto: `.sente/commands/`
...
sente include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
