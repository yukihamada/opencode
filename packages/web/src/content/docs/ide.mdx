---
title: IDE
description: The Sente extension for VS Code, Cursor, and other IDEs
---

Sente integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `sente` in the terminal to get started.
...
To install Sente on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `sente` - the extension installs automatically
...
Search for **Sente** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `sente` in the integrated terminal.
