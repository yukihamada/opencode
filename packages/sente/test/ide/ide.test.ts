...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SENTE_CALLER", () => {
    process.env["SENTE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SENTE_CALLER", () => {
    process.env["SENTE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SENTE_CALLER", () => {
    process.env["SENTE_CALLER"] = "unknown"
