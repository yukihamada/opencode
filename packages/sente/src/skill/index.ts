...
import { FrontmatterError } from "@sente-ai/core/v1/config/error"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, SENTE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@sente/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_SENTE_SKILL_NAME] = {
          name: CUSTOMIZE_SENTE_SKILL_NAME,
          description: CUSTOMIZE_SENTE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_SENTE_SKILL_BODY,
        }
