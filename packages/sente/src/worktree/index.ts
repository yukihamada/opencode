...
import { path } from "@sente-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@sente-ai/core/project"
...
import { WorktreeEvent } from "@sente-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@sente/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `sente/${name}`
