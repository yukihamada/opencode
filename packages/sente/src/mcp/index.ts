...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/sente/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/sente/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/sente/issues/2308
    roots: {},
    // https://github.com/anomalyco/sente/issues/28567
    // tasks: {},
  },
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: sente mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
