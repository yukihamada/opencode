...
import { normalizePromptContent } from "@sente-ai/tui/editor"
...
import { SENTE_BASE_MODE, useBindings } from "@sente-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Sente" } satisfies SlashOption,
    ]
