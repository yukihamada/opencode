...
import { openEditor } from "@sente-ai/tui/editor"
import { registerSenteKeymap } from "@sente-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerSenteKeymap(keymap, renderer, input.tuiConfig)
