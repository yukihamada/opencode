...
import type { Event, GlobalEvent, OpencodeClient } from "@sente-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@sente/RunStreamTransport") {}
