...
//
// The saved variant persists across sessions in ~/.local/state/sente/model.json
...
class Service extends Context.Service<Service, VariantService>()("@sente/RunVariant") {}
