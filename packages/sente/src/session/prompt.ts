...
import { MAX_STEPS_PROMPT } from "@sente-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@sente-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@sente/SessionPrompt") {}
