import type { JsonSchema, LLMRequest, ProviderMetadata } from "@sente-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@sente-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @sente-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
