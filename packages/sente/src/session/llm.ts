...
import { llmClient } from "@sente-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@sente-ai/llm"
import { LLMClient } from "@sente-ai/llm/route"
import type { LLMClientService } from "@sente-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@sente/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via sente's tool system
