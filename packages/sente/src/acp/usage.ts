...
import type { AssistantMessage as SenteAssistantMessage, Message } from "@sente-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<SenteAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SenteAssistantMessage, "role"> &
  Partial<Pick<SenteAssistantMessage, "providerID" | "modelID">>
