...
Schema-first LLM core for sente. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@sente-ai/llm"
import { OpenAI } from "@sente-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@sente-ai/llm/providers"
