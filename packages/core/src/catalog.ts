...
import { Catalog } from "@sente-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/Catalog") {}
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.sente) {
