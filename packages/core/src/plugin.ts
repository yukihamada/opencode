...
import type { Plugin as PluginRuntime } from "@sente-ai/plugin/v2/effect"
import { Plugin } from "@sente-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/Plugin") {}
