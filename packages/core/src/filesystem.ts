...
import { Entry, FileSystem, FindInput, Match } from "@sente-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@sente-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/FileSystem") {}
