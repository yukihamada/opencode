...
import { ConfigDataPolicyV1 } from "./data-policy"
...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for sente serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://teai.io/sente/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://teai.io/sente/docs/agents" }),
  ...
  dataPolicy: Schema.optional(ConfigDataPolicyV1.Info).annotate({
    description: "Outbound prompt masking and blocking rules for sensitive data",
  }),
