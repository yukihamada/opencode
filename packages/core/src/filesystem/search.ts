...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.SENTE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
