...
declare const SENTE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SENTE_LIBC === "undefined" ? undefined : SENTE_LIBC
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    if (location.vcs && (yield* Flag.SENTE_EXPERIMENTAL_FILEWATCHER)) {
