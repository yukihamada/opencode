...
import { Credential } from "@sente-ai/schema/credential"
import { Integration } from "@sente-ai/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/Credential") {}
