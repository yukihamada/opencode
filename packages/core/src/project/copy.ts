...
import { Event } from "@sente-ai/schema/project-directories"
import { ProjectCopy } from "@sente-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@sente/ProjectCopy") {}
