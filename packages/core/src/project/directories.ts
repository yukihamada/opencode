...
import type { EffectDrizzleSqlite } from "@sente-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@sente/ProjectDirectories") {}
