...
import type { Data, Definition, Payload } from "@sente-ai/schema/event"
...
import { Durable } from "@sente-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@sente-ai/schema/event").ID
export type { Data, Definition, Payload } from "@sente-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@sente/Event") {}
