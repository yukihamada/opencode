...
import { ListAnchor } from "@sente-ai/schema/session"
...
import { SessionDurable } from "@sente-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/Session") {}
