...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@sente-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@sente/v2/ToolRegistry") {}
