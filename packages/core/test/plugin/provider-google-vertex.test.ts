...
import { GoogleVertexPlugin } from "@sente-ai/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.sente, (provider) => {
          provider.api = {
            ...
            url: "https://teai.io/sente/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.sente))
