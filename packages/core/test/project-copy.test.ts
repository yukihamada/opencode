...
import { Git } from "@sente-ai/core/git"
...
import { ProjectDirectoryTable, ProjectTable } from "@sente-ai/core/project/sql"
import { ProjectCopy } from "@sente-ai/core/project/copy"
import { ProjectDirectories } from "@sente-ai/core/project/directories"
...
async function initRepo(directory: string) {
  ...
  await $`git config user.email test@sente.test`.cwd(directory).quiet()
