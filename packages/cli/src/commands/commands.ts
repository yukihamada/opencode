...
declare const SENTE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof SENTE_CLI_NAME === "string" ? SENTE_CLI_NAME : "sente", {
  description: "Sente 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
