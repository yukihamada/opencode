...
import type { Definition } from "@sente-ai/schema/event"
...
export const SenteEvent = event.schema
export type SenteEvent = typeof SenteEvent.Type
export type SenteEventEncoded = typeof SenteEvent.Encoded
