export const dict = {
  ...
  "app.description":
    "Esplora l'utilizzo di Sente nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Sente.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Sente per modello.",
  ...
  "lab.description":
    "Confronta i modelli {{lab}} usati in Sente, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  ...
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Sente, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Sente appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Sente della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Sente della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Sente nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Sente, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Sente.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Sente nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Sente nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Sente.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Sente corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Sente.",
