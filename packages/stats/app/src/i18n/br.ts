export const dict = {
  ...
  "app.description":
    "Explore o uso do Sente em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Sente.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Sente por modelo.",
  ...
  "lab.description":
    "Compare modelos da {{lab}} usados no Sente, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  ...
  "model.description":
    "Veja dados de uso de {{model}} no Sente, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Sente aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Sente da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Sente da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Sente na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Sente, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Sente.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Sente na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Sente na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Sente.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Sente correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Sente.",
