export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | Sente Data",
  "app.description":
    "Досліджуйте використання Sente Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак Sente Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку Sente на GitHub",
  "header.github": "GitHub",
  "header.trySente": "Спробувати Sente",
  ...
  "home.topModelsDescription": "Використання моделей в Sente Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі Sente Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | Sente Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в Sente Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання Sente.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в Sente",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання Sente",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів Sente за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | Sente Data",
  "model.description":
    "Перегляньте дані використання {{model}} в Sente Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання Sente Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні Sente Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні Sente Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання Sente Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени Sente Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання Sente Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів Sente Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі Sente Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу Sente Go.",
  ...
  "model.geoDescription": "Токени моделі Sente Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки Sente Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів Sente Go.",
