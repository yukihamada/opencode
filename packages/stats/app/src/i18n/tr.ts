export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Sente Data",
  "app.description":
    "Sente Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Sente Data logosu",
  ...
  "header.githubAria": "GitHub'da Sente'a yıldız ver",
  "header.github": "GitHub",
  "header.trySente": "Sente'u dene",
  ...
  "footer.homeAria": "Sente ana sayfası",
  ...
  "home.topModelsDescription": "Sente Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Sente Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Sente Data",
  "lab.description":
    "Sente Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Sente kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Sente'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Sente kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Sente token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Sente Data",
  "model.description":
    "{{model}} için Sente Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Sente Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Sente Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Sente Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Sente Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Sente Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Sente Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Sente Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Sente Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Sente Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Sente Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Sente Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Sente Go token hacmine göre yakındaki modeller.",
