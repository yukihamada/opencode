export const dict = {
  ...
  "app.description":
    "Sente kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  ...
  "home.topModelsDescription": "Sente genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Sente kullanıcıları.",
  ...
  "lab.description":
    "Sente'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  ...
  "model.description":
    "{{model}} için Sente kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Sente kullanımı görünür.",
  "model.unranked": "Geçen haftaki Sente kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Sente kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Sente kullanımı yok.",
  ...
  "model.overviewDescription": "Son Sente tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Sente kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Sente token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Sente kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Sente oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Sente coğrafi satırı yok.",
  "model.peersDescription": "Son Sente token hacmine göre yakındaki modeller.",
