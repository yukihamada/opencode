export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie Sente w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "home.topModelsDescription": "Użycie modeli w Sente.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Sente według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w Sente, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w Sente, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Sente pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Sente z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Sente z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Sente w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Sente, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Sente.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Sente w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Sente w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Sente.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Sente nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Sente.",
