export const dict = {
  "app.title": "Rankingi użycia modeli AI | Sente Data",
  "app.description":
    "Przeglądaj użycie Sente Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Sente Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Sente na GitHub",
  "header.github": "GitHub",
  "header.trySente": "Wypróbuj Sente",
  ...
  "footer.homeAria": "Strona główna Sente",
  ...
  "home.topModelsDescription": "Użycie modeli w Sente Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Sente Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Sente Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Sente Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Sente.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Sente",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Sente",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Sente z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Sente Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Sente Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Sente Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Sente Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Sente Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Sente Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Sente Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Sente Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Sente Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Sente Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Sente Go.",
  ...
  "model.geoDescription": "Tokeny modelu Sente Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Sente Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Sente Go.",
