export const dict = {
  ...
  "app.description":
    "Explora el uso de Sente en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Sente.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Sente por modelo.",
  ...
  "lab.description":
    "Compara modelos de {{lab}} usados en Sente, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  ...
  "model.description":
    "Consulta datos de uso de {{model}} en Sente, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Sente aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Sente de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Sente de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Sente en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Sente, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Sente.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Sente durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Sente durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Sente.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de Sente coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Sente.",
