...
const en = {
  "app.title": "AI Model Usage Rankings | Sente Data",
  "app.description":
    "Explore Sente Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Sente Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Sente on GitHub",
  "header.github": "GitHub",
  "header.trySente": "Try Sente",
  ...
  "home.topModelsDescription": "Usage of models across Sente Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Sente Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Sente Data",
  "lab.description":
    "Compare {{lab}} models used in Sente Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Sente usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Sente",
  ...
  "lab.shareOfUsage": "{{share}} of recent Sente usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Sente Data",
  "model.description":
    "View {{model}} Sente Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Sente Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Sente Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Sente Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Sente Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Sente Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Sente Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Sente Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Sente Go token volume.",
