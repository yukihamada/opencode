...
import { Session } from "@sente-ai/sdk/v2/client"
...
import { toaster } from "@sente-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@sente-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://teai.io/sente/desktop-feedback")}
      renderPanel={() =>
