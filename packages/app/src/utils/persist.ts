...
const GLOBAL_STORAGE = "sente.global.dat"
const WINDOW_STORAGE = "sente.window"
const LOCAL_PREFIX = "sente."
...
function workspaceStorage(dir: string) {
  ...
  return `sente.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `sente.draft.${head}.${sum}.dat`
}
