export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Sente aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Sente ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Sente installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.senteMissing": "sente pole sellesse distrosse installitud",
  "desktop.wsl.error.senteCannotRun": "sente on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "Sente pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.sente.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.sente.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.senteGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Sente",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Sente'is.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.senteZen.visit.prefix": "Külastage ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Sente.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis sente.json",
  ...
  "dialog.server.description": "Lülitage, millise Sente serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Sente kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sente värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Sente värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Sente jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Sente asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Sente saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Sente ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Sente.",
  ...
  "help.tabs.introduction": "Sente Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Sente ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Sente meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (sente.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Sente ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Sente sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Sente Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Sente server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Sente kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Sente teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Sente järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Sente on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Sente käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Sente uusimat versiooni.",
