...
const desktop = [
  ...
  "Kilépés",
  "Az Sente betöltése sikertelen",
  "Az Sente ablaka váratlanul leállt",
  "Az Sente nem válaszol",
  ...
  "Az Sente telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az sente nincs telepítve ebben a disztribúcióban",
  "Az sente telepítve van, de nem futtatható",
  "Az Sente nincs telepítve ebben: {{distro}}",
  "Az Sente frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.sente.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.sente.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.senteGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Sente ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Sente-ben.",
  ...
  "provider.connect.senteZen.line1":
    "A Sente Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.senteZen.visit.prefix": "Látogatás",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Sente-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Sente-ben.",
  ...
  "dialog.plugins.empty": "Az sente.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Sente szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "Sente ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "Sente frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "Sente frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a Sente-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a Sente-t",
  "wsl.onboarding.opencodeReadyIn": "A Sente készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A Sente készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a Sente-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a Sente-t",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "A Sente nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Sente hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Sente nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Sente programot.",
  ...
  "help.tabs.introduction": "A Sente Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Sente ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Sente csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (sente.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Sente még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Sente ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Sente asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Sente szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Sente kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Sente az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Sente a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Sente témáját.",
  ...
  "settings.updates.row.startup.description": "A Sente indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Sente legújabb verzióját futtatja.",
