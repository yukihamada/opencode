...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Sente se nije uspio učitati",
  "Prozor aplikacije Sente neočekivano je zatvoren",
  "Sente ne reagira",
  ...
  "Instalacija aplikacije Sente nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "sente nije instaliran u ovoj distribuciji",
  "sente je instaliran, ali se ne može pokrenuti",
  "Sente nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Sente je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.sente.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.sente.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.senteGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Sente",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.senteZen.visit.prefix": "Posjetiti",
  "provider.connect.senteZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.senteZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Sente.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u sente.json",
  ...
  "dialog.server.description": "Promijenite na koji se Sente poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Sente u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Sente u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Sente u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Sente u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Sente",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Sente može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Sente nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Sente.",
  ...
  "help.tabs.introduction": "Radna površina Sente sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Sente ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Sente timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (sente.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Sente još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Sente uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Sente Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Sente poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Sente",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Sente izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Sente slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Sente tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Sente pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Sente.",
