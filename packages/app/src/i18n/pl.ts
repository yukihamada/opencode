export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Sente",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Sente",
  "desktop.recovery.terminated": "Okno Sente zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Sente nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Sente",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.senteMissing": "sente nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.senteCannotRun": "sente jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "Sente nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Sente została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.sente.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.sente.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.senteGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Sente",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.senteZen.visit.prefix": "Odwiedź ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Sente.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku sente.json",
  ...
  "dialog.server.description": "Przełącz serwer Sente, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Sente w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Sente w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Sente w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Sente w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Sente będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Sente nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Sente ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Sente",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (sente.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Sente nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Sente zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Sente wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Sente",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Sente na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Sente ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Sente.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Sente",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Sente.",
