export const dict = {
  ...
  "dialog.provider.sente.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.sente.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.senteGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w sente.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (sente.json) nazwy dostawców/modeli",
