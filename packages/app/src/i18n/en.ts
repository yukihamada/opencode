...
export const dict = {
  ...
  "dialog.provider.sente.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.sente.tagline": "Reliable optimized models",
  "dialog.provider.senteGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Sente",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Sente.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.senteZen.line1":
    "Sente Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.senteZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.senteZen.visit.prefix": "Visit ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Sente.",
  ...
  "dialog.plugins.empty": "Plugins configured in sente.json",
  ...
  "dialog.server.description": "Switch which Sente server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Sente in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Sente in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Sente in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Sente in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Sente can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Sente could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Sente ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Sente team",
  ...
  "error.chain.checkConfig": "Check your config (sente.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Sente does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Sente includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Sente server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Sente",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Sente looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Sente follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Sente is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Sente launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Sente.",
