export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Sente",
  ...
  "desktop.menu.ariaLabel": "Menuja Sente",
  ...
  "desktop.recovery.loadFailed": "Sente nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Sente u mbyll papritur",
  "desktop.recovery.unresponsive": "Sente nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Sente dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.senteMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.senteCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.opencodeNotInstalled": "Sente nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Sente përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.sente.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.sente.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.senteGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Sente",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.senteZen.visit.prefix": "Vizitoni ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Sente.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në sente.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Sente lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Sente në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sente po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Sente në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Sente në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Sente në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Sente të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Sente nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Sente ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Sente",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (sente.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Sente nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Sente brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Sente",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Sente në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Sente ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Sente.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Sente",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Sente.",
