export const dict = {
  ...
  "desktop.menu.documentation": "Sente Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Sente ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Sente se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Sente se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Sente ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.senteMissing": "sente ni nameščen v tej distribuciji",
  "desktop.wsl.error.senteCannotRun": "sente je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "Sente ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Sente je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.sente.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.sente.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.senteGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Sente",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.senteZen.visit.prefix": "Obisk ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Sente.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v sente.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Sente se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Sente ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Sente v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Sente ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Sente v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Sente v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Sente v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Sente doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Sente ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Sente ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Sente",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (sente.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Sente še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Sente znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Sente",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Sente izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Sente sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Sente.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Sente",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Sente.",
