export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹرو وچ sente انسٹال نئیں اے",
  "desktop.wsl.error.opencodeCannotRun": "sente انسٹال اے پر چل نئیں سکیا",
  ...
  "wsl.onboarding.checkingSente": "Sente چیک کر رئے آں...",
  "wsl.onboarding.checkingSenteIn": "{{distro}} چ Sente دی جانچ پڑتال...",
  "wsl.onboarding.updatingSente": "Sente نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingSenteIn": "{{distro}} وچ Sente نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateSenteIn": "{{distro}} وچ Sente نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateSente": "Sente اپ ڈیٹ کرو",
  "wsl.onboarding.senteReadyIn": "Sente {{distro}} چ تیار اے۔",
  "wsl.onboarding.senteReady": "Sente تیار اے۔",
  "wsl.onboarding.installSenteIn": "{{distro}} وچ Sente انسٹال کرو۔",
  "wsl.onboarding.installSente": "Sente انسٹال کرو",
