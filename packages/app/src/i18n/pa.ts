export const dict = {
  ...
  "desktop.menu.documentation": "Sente دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Sente لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Sente دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Sente جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Sente دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.senteMissing": "sente انسٹال نئیں اے",
  "desktop.wsl.error.senteCannotRun": "sente انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Sente انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Sente دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.sente.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.sente.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.senteGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Sente وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.senteZen.visit.prefix": "ویکھو ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Sente وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Sente وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "sente.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Sente سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Sente چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Sente دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Sente نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Sente نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Sente نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Sente اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Sente تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Sente انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Sente انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Sente دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Sente ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Sente دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Sente Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Sente ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (sente.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Sente ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Sente چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Sente سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Sente لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Sente کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Sente سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Sente نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Sente لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Sente دا تازہ ترین ورژن چلا رئے او۔",
