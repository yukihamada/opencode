...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "sente kurulu ancak çalıştırılamadı",
  ...
  "wsl.onboarding.checkingSente": "Sente kontrol ediliyor...",
  "wsl.onboarding.checkingSenteIn": "{{distro}} içinde Sente kontrol ediliyor...",
  "wsl.onboarding.updatingSente": "Sente güncelleniyor...",
  "wsl.onboarding.updatingSenteIn": "{{distro}} içinde Sente güncelleniyor...",
  "wsl.onboarding.updateSenteIn": "{{distro}} içindeki Sente'u güncelleyin.",
  "wsl.onboarding.updateSente": "Sente'u güncelle",
  "wsl.onboarding.senteReadyIn": "{{distro}} içinde Sente hazır.",
  "wsl.onboarding.senteReady": "Sente hazır.",
  "wsl.onboarding.installSenteIn": "Sente'u {{distro}} içine kurun.",
  "wsl.onboarding.installSente": "Sente'u kur",
