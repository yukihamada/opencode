...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente yüklenemedi",
  "desktop.recovery.terminated": "Sente penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Sente yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Sente kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.senteMissing": "sente bu dağıtımda kurulu değil",
  "desktop.wsl.error.senteCannotRun": "sente kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "Sente, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Sente güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.sente.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.sente.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.senteGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Sente'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.senteZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Sente'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Sente'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler sente.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Sente sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Sente kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Sente güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Sente güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Sente'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Sente'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Sente hazır.",
  "wsl.onboarding.opencodeReady": "Sente hazır.",
  "wsl.onboarding.installOpencodeIn": "Sente'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Sente'u kur",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Sente'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Sente bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Sente'u tekrar açın.",
  ...
  "help.tabs.introduction": "Sente Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Sente ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (sente.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Sente henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Sente ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Sente Masaüstü",
  ...
  "settings.desktop.wsl.description": "Sente sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Sente'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Sente'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Sente'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sente'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Sente başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Sente'un en son sürümünü kullanıyorsunuz.",
