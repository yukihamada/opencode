...
export const dict = {
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Sente ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (sente.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Sente henüz MCP kimlik doğrulamasını desteklemiyor.',
