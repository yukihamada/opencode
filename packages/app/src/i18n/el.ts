export const dict = {
  ...
  "desktop.menu.documentation": "Sente Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Sente μενού",
  ...
  "desktop.recovery.loadFailed": "Sente απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Sente το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Sente δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Sente η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.senteMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.senteCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.opencodeNotInstalled": "Sente δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.sente.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.sente.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.senteGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Sente",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  "provider.connect.senteZen.line2":
    "Με ένα μόνο κλειδί API θα έχετε πρόσβαση σε μοντέλα όπως Claude, GPT, Gemini, GLM και άλλα.",
  "provider.connect.senteZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Sente.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο sente.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Sente συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.step.sente": "Sente",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Sente σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Sente σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Sente σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Sente στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Sente να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Sente δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Sente.",
  ...
  "help.tabs.introduction": "Sente Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Sente ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Sente",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (sente.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Sente δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Sente Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Sente μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Sente",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Sente στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Sente ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Sente.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Sente",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Sente.",
