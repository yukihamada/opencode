export const dict = {
  ...
  "desktop.menu.documentation": "Sente dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Sente izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Sente",
  "desktop.recovery.terminated": "Sente logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Sente neatbild",
  ...
  "desktop.wsl.error.installOpencode": "Sente instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.senteMissing": "sente nav instalēts šajā distribūcijā",
  "desktop.wsl.error.senteCannotRun": "sente ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.opencodeNotInstalled": "Sente nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.sente.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.sente.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.senteGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Sente",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  "provider.connect.senteZen.line2":
    "Ar vienu API atslēgu iegūsiet piekļuvi tādiem modeļiem kā Claude, GPT, Gemini, GLM un citiem.",
  "provider.connect.senteZen.visit.prefix": "Apmeklējiet",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Sente.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti sente.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Sente servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu Sente distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu Sente distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet Sente distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet Sente distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Sente var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Sente neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Sente no jauna.",
  ...
  "help.tabs.introduction": "Sente Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Sente versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Sente komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (sente.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Sente vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Sente ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Sente darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Sente serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Sente saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Sente izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Sente sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Sente tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Sente",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Sente versiju.",
