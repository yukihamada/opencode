export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Sente",
  ...
  "desktop.recovery.loadFailed": "Sente gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Sente ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Sente tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Sente gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.senteMissing": "sente tidak dipasang dalam distro ini",
  "desktop.wsl.error.senteCannotRun": "sente dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Sente tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Sente selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.sente.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.sente.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.senteGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Sente",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.senteZen.visit.prefix": "Layari",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Sente.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam sente.json",
  ...
  "dialog.server.description": "Tukar pelayan Sente yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Sente dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Sente dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Sente dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Sente dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Sente boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Sente tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Sente ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Sente",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (sente.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Sente belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Sente dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Sente",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Sente pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Sente mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Sente.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Sente dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Sente.",
