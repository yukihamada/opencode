export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.opencodeMissing": "এই ডিস্ট্রোতে sente ইনস্টল করা নেই",
  "desktop.wsl.error.opencodeCannotRun": "sente ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  ...
  "wsl.onboarding.checkingSente": "Sente পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingSenteIn": "{{distro}} এ Sente চেক করা হচ্ছে...",
  "wsl.onboarding.updatingSente": "আপডেট করা হচ্ছে Sente...",
  "wsl.onboarding.updatingSenteIn": "{{distro}}-এ Sente আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateSenteIn": "{{distro}}-এ Sente আপডেট করুন।",
  "wsl.onboarding.updateSente": "Sente আপডেট করুন",
  "wsl.onboarding.senteReadyIn": "Sente {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.senteReady": "Sente প্রস্তুত।",
  "wsl.onboarding.installSenteIn": "{{distro}}-এ Sente ইনস্টল করুন।",
  "wsl.onboarding.installSente": "Sente ইনস্টল করুন",
