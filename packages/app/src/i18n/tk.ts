export const dict = {
  ...
  "desktop.menu.documentation": "Sente Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Sente menýusy",
  ...
  "desktop.recovery.loadFailed": "Sente ýükläp bilmedi",
  "desktop.recovery.terminated": "Sente penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Sente jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Sente gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.senteMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.senteCannotRun": "sente guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.opencodeNotInstalled": "Sente {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Sente täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.sente.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.sente.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.senteGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Sente-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.senteZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.senteZen.visit.prefix": "Sapar ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Sente-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Sente-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "sente.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Sente serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Sente barlanýar...",
  "wsl.onboarding.updatingOpencode": "Sente täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Sente täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "Sente-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Sente täzeläň",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "Sente taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Sente guruň.",
  "wsl.onboarding.installOpencode": "Sente guruň",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Sente WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Sente bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Sente açyň.",
  ...
  "help.tabs.introduction": "Sente Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Sente ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Sente toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (sente.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Sente entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Sente mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Sente serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Sente üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Sente enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Sente ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Sente-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Sente işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Sente-iň iň soňky wersiýasyny işleýärsiňiz.",
