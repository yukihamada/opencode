export const dict = {
  ...
  "desktop.menu.documentation": "Sente hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Sente menyusi",
  ...
  "desktop.recovery.loadFailed": "Sente yuklanmadi",
  "desktop.recovery.terminated": "Sente oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Sente javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Sente oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.senteMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.senteCannotRun": "sente o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "Sente {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Sente yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.sente.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.sente.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.senteGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Sente’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.senteZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Sente da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Sente da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "sente.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Sente serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Sente {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Sente yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Sente {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Sente-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Sente-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Sente tayyor.",
  "wsl.onboarding.installOpencodeIn": "Sente-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Sente-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Sente WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Sente WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Sente-ni qayta oching.",
  ...
  "help.tabs.introduction": "Sente Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Sente jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (sente.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Sente hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Sente bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Sente serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Sente uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Sente qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Sente tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Sente mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Sente ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Sente oxirgi versiyasini ishga tushiryapsiz.",
