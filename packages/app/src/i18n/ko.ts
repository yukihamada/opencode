export const dict = {
  ...
  "wsl.onboarding.checkingSente": "Sente 확인 중...",
  "wsl.onboarding.checkingSenteIn": "{{distro}}에서 Sente 확인 중...",
  "wsl.onboarding.updatingSente": "Sente 업데이트 중...",
  "wsl.onboarding.updatingSenteIn": "{{distro}}에서 Sente 업데이트 중...",
  "wsl.onboarding.updateSenteIn": "{{distro}}에서 Sente를 업데이트하세요.",
  "wsl.onboarding.updateSente": "Sente 업데이트",
  "wsl.onboarding.senteReadyIn": "{{distro}}에서 Sente를 사용할 준비가 되었습니다.",
  "wsl.onboarding.senteReady": "Sente가 준비되었습니다.",
  "wsl.onboarding.installSenteIn": "{{distro}}에 Sente를 설치하세요.",
  "wsl.onboarding.installSente": "Sente 설치",
  ...
  "desktop.wsl.error.opencodeMissing": "이 배포판에 sente가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "sente가 설치되어 있지만 실행할 수 없습니다",
