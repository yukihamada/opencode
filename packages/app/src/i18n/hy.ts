export const dict = {
  ...
  "desktop.menu.documentation": "Sente Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Sente մենյու",
  ...
  "desktop.recovery.loadFailed": "Sente չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Sente պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Sente-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Sente տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.senteMissing": "sente-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.senteCannotRun": "sente-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.opencodeNotInstalled": "Sente տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.sente.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.sente.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.senteGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Sente",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Sente-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.senteZen.visit.prefix": "Այցելություն ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Sente-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Sente-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են sente.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Sente սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Sente-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Sente-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Sente-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Sente պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Sente-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Sente-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Sente-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Sente։",
  ...
  "help.tabs.introduction": "Sente Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Sente թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (sente.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Sente-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Sente ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Sente սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Sente",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Sente տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Sente-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Sente-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Sente-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Sente-ի վերջին տարբերակը։",
