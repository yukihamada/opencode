export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはsenteがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "senteはインストールされていますが、実行できませんでした",
  ...
  "wsl.onboarding.checkingSente": "Senteを確認中...",
  "wsl.onboarding.checkingSenteIn": "{{distro}}内のSenteを確認中...",
  "wsl.onboarding.updatingSente": "Senteを更新中...",
  "wsl.onboarding.updatingSenteIn": "{{distro}}内のSenteを更新中...",
  "wsl.onboarding.updateSenteIn": "{{distro}}内のSenteを更新してください。",
  "wsl.onboarding.updateSente": "Senteを更新",
  "wsl.onboarding.senteReadyIn": "{{distro}}内のSenteの準備ができました。",
  "wsl.onboarding.senteReady": "Senteの準備ができました。",
  "wsl.onboarding.installSenteIn": "{{distro}}にSenteをインストールしてください。",
  "wsl.onboarding.installSente": "Senteをインストール",
