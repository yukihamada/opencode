export const dict = {
  ...
  "desktop.recovery.loadFailed": "Senteを読み込めませんでした",
  "desktop.recovery.terminated": "Senteのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Senteが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Senteのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.senteMissing": "senteがインストールされていません",
  "desktop.wsl.error.senteCannotRun": "senteはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはSenteがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Senteのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.sente.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.sente.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.senteGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Senteが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Senteで{{provider}}モデルを使用します。",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.senteZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.senteZen.visit.prefix": " ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してSenteで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Senteで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "sente.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するSenteサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Senteを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のSenteを確認中...",
  "wsl.onboarding.updatingOpencode": "Senteを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のSenteを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のSenteを更新してください。",
  "wsl.onboarding.updateOpencode": "Senteを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のSenteの準備ができました。",
  "wsl.onboarding.opencodeReady": "Senteの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にSenteをインストールしてください。",
  "wsl.onboarding.installOpencode": "Senteをインストール",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Senteがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SenteでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Senteをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Sente Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Senteの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをSenteチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (sente.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: SenteはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Senteには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でSenteサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Senteの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのSenteの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Senteがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Senteのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Sente の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Sente は最新バージョンです。",
