export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "O sente não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O sente está instalado, mas não pôde ser executado",
  ...
  "wsl.onboarding.checkingSente": "Verificando o Sente...",
  "wsl.onboarding.checkingSenteIn": "Verificando o Sente em {{distro}}...",
  "wsl.onboarding.updatingSente": "Atualizando o Sente...",
  "wsl.onboarding.updatingSenteIn": "Atualizando o Sente em {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Atualize o Sente em {{distro}}.",
  "wsl.onboarding.updateSente": "Atualizar o Sente",
  "wsl.onboarding.senteReadyIn": "O Sente está pronto em {{distro}}.",
  "wsl.onboarding.senteReady": "O Sente está pronto.",
  "wsl.onboarding.installSenteIn": "Instale o Sente em {{distro}}.",
  "wsl.onboarding.installSente": "Instalar o Sente",
