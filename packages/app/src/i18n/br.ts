export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Sente",
  ...
  "desktop.menu.ariaLabel": "Menu do Sente",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Sente",
  "desktop.recovery.terminated": "A janela do Sente foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Sente não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Sente",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.senteMissing": "sente não está instalado nesta distribuição",
  "desktop.wsl.error.senteCannotRun": "sente está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O Sente não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Sente foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.sente.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.sente.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.senteGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Sente",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.senteZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.senteZen.visit.prefix": "Visite ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Sente.",
  ...
  "dialog.plugins.empty": "Plugins configurados em sente.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Sente este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Sente em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Sente em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Sente em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Sente",
  "wsl.onboarding.opencodeReadyIn": "O Sente está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Sente está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Sente em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Sente possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Sente não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Sente novamente.",
  ...
  "help.tabs.introduction": "Agora, o Sente Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Sente ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Sente",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (sente.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Sente ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Sente dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Sente",
  ...
  "settings.general.row.appearance.description": "Personalize como o Sente aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Sente segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Sente é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Sente iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Sente.",
