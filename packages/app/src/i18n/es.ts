export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "sente está instalado, pero no se pudo ejecutar",
  ...
  "wsl.onboarding.checkingSente": "Comprobando Sente...",
  "wsl.onboarding.checkingSenteIn": "Comprobando Sente en {{distro}}...",
  "wsl.onboarding.updatingSente": "Actualizando Sente...",
  "wsl.onboarding.updatingSenteIn": "Actualizando Sente en {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Actualiza Sente en {{distro}}.",
  "wsl.onboarding.updateSente": "Actualizar Sente",
  "wsl.onboarding.senteReadyIn": "Sente está listo en {{distro}}.",
  "wsl.onboarding.senteReady": "Sente está listo.",
  "wsl.onboarding.installSenteIn": "Instala Sente en {{distro}}.",
  "wsl.onboarding.installSente": "Instalar Sente",
