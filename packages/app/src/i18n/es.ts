export const dict = {
  ...
  "dialog.provider.sente.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Sente se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Sente",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Sente no soporta autenticación MCP todavía.',
