export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Sente",
  ...
  "desktop.menu.ariaLabel": "Menú de Sente",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Sente",
  "desktop.recovery.terminated": "La ventana de Sente se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Sente no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Sente",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.senteMissing": "sente no está instalado en esta distribución",
  "desktop.wsl.error.senteCannotRun": "sente está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "Sente no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Sente finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.sente.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.sente.tagline": "Modelos optimizados y fiables",
  "dialog.provider.senteGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Sente",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.senteZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Sente.",
  ...
  "dialog.plugins.empty": "Plugins configurados en sente.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Sente al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Sente en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Sente en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Sente en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Sente en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Sente pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Sente no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Sente ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Sente",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (sente.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Sente aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Sente dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Sente",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Sente en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Sente sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Sente.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Sente",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Sente.",
