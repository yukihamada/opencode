...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente 加载失败",
  "desktop.recovery.terminated": "Sente 窗口意外终止",
  "desktop.recovery.unresponsive": "Sente 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Sente 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.senteMissing": "sente",
  "desktop.wsl.error.senteCannotRun": "sente，但无法运行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Sente",
  "desktop.wsl.error.updateVersion":
    "Sente 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.sente.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.sente.tagline": "可靠的优化模型",
  "dialog.provider.senteGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Sente 中使用 {{provider}} 模型。",
  ...
  "provider.connect.senteZen.line1": "Sente Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.senteZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.senteZen.visit.prefix": "访问 ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Sente 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Sente 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 sente.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Sente 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Sente...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Sente...",
  "wsl.onboarding.updatingOpencode": "正在更新 Sente...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Sente...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Sente。",
  "wsl.onboarding.updateOpencode": "更新 Sente",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Sente 已就绪。",
  "wsl.onboarding.opencodeReady": "Sente 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Sente。",
  "wsl.onboarding.installOpencode": "安装 Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "未安装 Sente",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Sente 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Sente 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Sente。",
  ...
  "help.tabs.introduction": "Sente Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Sente 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (sente.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Sente 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Sente 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Sente 服务器。",
  ...
  "settings.general.row.language.description": "更改 Sente 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Sente 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Sente 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Sente 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Sente 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Sente。",
