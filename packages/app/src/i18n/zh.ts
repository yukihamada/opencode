...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "此发行版中未安装 sente",
  "desktop.wsl.error.opencodeCannotRun": "已安装 sente，但无法运行",
  ...
  "wsl.onboarding.checkingSente": "正在检查 Sente...",
  "wsl.onboarding.checkingSenteIn": "正在检查 {{distro}} 中的 Sente...",
  "wsl.onboarding.updatingSente": "正在更新 Sente...",
  "wsl.onboarding.updatingSenteIn": "正在更新 {{distro}} 中的 Sente...",
  "wsl.onboarding.updateSenteIn": "更新 {{distro}} 中的 Sente。",
  "wsl.onboarding.updateSente": "更新 Sente",
  "wsl.onboarding.senteReadyIn": "{{distro}} 中的 Sente 已就绪。",
  "wsl.onboarding.senteReady": "Sente 已就绪。",
  "wsl.onboarding.installSenteIn": "在 {{distro}} 中安装 Sente。",
  "wsl.onboarding.installSente": "安装 Sente",
