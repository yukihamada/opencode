...
export const dict = {
  ...
  "desktop.menu.documentation": "Sente-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Sente-meny",
  ...
  "desktop.recovery.loadFailed": "Sente kunne ikke lastes inn",
  "desktop.recovery.terminated": "Sente-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Sente svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Sente mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.senteMissing": "sente er ikke installert i denne distribusjonen",
  "desktop.wsl.error.senteCannotRun": "sente er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "Sente er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Sente er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.sente.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.sente.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.senteGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Sente",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.senteZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.senteZen.visit.prefix": "Besøk ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Sente.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i sente.json",
  ...
  "dialog.server.description": "Bytt hvilken Sente-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Sente ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Sente-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (sente.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Sente ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Sente inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Sente-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Sente",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Sente ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Sente skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Sente.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Sente starter",
  ...
  "settings.updates.toast.latest.title": "Sente er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Sente.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Sente i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Sente i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Sente i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Sente i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Sente kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Sente kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Sente på nytt.",
  ...
  "help.tabs.introduction": "Sente Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
