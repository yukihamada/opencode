...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Sente.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i sente.json",
  ...
  "settings.general.row.colorScheme.description": "Velg om Sente skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Sente er tematisert.",
