...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "sente er installert, men kunne ikke kjøres",
  ...
  "wsl.onboarding.checkingSente": "Sjekker Sente...",
  "wsl.onboarding.checkingSenteIn": "Sjekker Sente i {{distro}}...",
  "wsl.onboarding.updatingSente": "Oppdaterer Sente...",
  "wsl.onboarding.updatingSenteIn": "Oppdaterer Sente i {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Oppdater Sente i {{distro}}.",
  "wsl.onboarding.updateSente": "Oppdater Sente",
  "wsl.onboarding.senteReadyIn": "Sente er klar i {{distro}}.",
  "wsl.onboarding.senteReady": "Sente er klar.",
  "wsl.onboarding.installSenteIn": "Installer Sente i {{distro}}.",
