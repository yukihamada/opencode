export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente yüklənə bilmədi",
  "desktop.recovery.terminated": "Sente pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Sente cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Sente quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.senteMissing": "sente quraşdırılmayıb",
  "desktop.wsl.error.senteCannotRun": "sente quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "Sente {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Sente yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.sente.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.sente.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.senteGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Sente-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.senteZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.senteZen.visit.prefix": "",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Sente-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Sente-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər sente.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Sente serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Sente yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Sente yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Sente yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Sente-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Sente-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Sente hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Sente-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Sente quraşdırın",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Sente WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Sente bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Sente-u yenidən açın.",
  ...
  "help.tabs.introduction": "Sente Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Sente komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (sente.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Sente hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Sente-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Sente serverini işlət.",
  ...
  "settings.general.row.language.description": "Sente üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Sente-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Sente-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Sente-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Sente açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Sente-un ən son versiyasından istifadə edirsiniz.",
