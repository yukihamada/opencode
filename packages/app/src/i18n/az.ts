export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə sente quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "sente quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  ...
  "wsl.onboarding.checkingSente": "Sente yoxlanılır...",
  "wsl.onboarding.checkingSenteIn": "{{distro}}-də Sente yoxlanılır...",
  "wsl.onboarding.updatingSente": "Sente yenilənir...",
  "wsl.onboarding.updatingSenteIn": "{{distro}}-də Sente yenilənir...",
  "wsl.onboarding.updateSenteIn": "{{distro}}-də Sente-u yeniləyin.",
  "wsl.onboarding.updateSente": "Sente-u yeniləyin",
  "wsl.onboarding.senteReadyIn": "Sente {{distro}}-də hazırdır.",
  "wsl.onboarding.senteReady": "Sente hazırdır.",
  "wsl.onboarding.installSenteIn": "Sente-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installSente": "Sente quraşdırın",
