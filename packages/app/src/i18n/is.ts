...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Sente",
  "Sente-glugganum var óvænt lokað",
  "Sente svarar ekki",
  ...
  "Uppsetning Sente mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "sente er ekki uppsett í þessari dreifingu",
  "sente er uppsett en ekki var hægt að keyra það",
  "Sente er ekki uppsett í {{distro}}",
  "Uppfærslu Sente lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.sente.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.sente.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.senteGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Sente",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.senteZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.senteZen.visit.prefix": "Heimsókn",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Sente.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í sente.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Sente miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Sente í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Sente í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Sente í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Sente í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Sente getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Sente gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Sente aftur.",
  ...
  "help.tabs.introduction": "Sente Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Sente ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Sente teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (sente.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Sente styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Sente inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Sente skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Sente netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Sente",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Sente lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Sente fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Sente er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Sente ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Sente.",
