export const dict = {
  ...
  "desktop.menu.documentation": "Sente दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Sente मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Sente लोड नहीं हो सका",
  "desktop.recovery.terminated": "Sente विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Sente प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Sente इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.senteMissing": "sente इंस्टॉल नहीं है",
  "desktop.wsl.error.senteCannotRun": "sente इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Sente इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Sente अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.sente.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.sente.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.senteGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Sente में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.senteZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.senteZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Sente में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Sente में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन sente.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Sente सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Sente की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Sente की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Sente अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Sente अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Sente को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Sente को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Sente तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Sente स्थापित करें।",
  "wsl.onboarding.installOpencode": "Sente स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Sente द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Sente इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Sente को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Sente Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Sente टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (sente.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Sente अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Sente में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Sente सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Sente के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Sente आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Sente सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Sente की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Sente लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Sente का नवीनतम संस्करण चला रहे हैं।",
