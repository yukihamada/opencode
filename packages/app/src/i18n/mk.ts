export const dict = {
  ...
  "desktop.menu.documentation": "Sente Документација",
  ...
  "desktop.menu.ariaLabel": "Sente мени",
  ...
  "desktop.recovery.loadFailed": "Sente не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Sente неочекувано заврши",
  "desktop.recovery.unresponsive": "Sente не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата Sente не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.senteMissing": "sente не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.senteCannotRun": "sente е инсталиран, но не може да се изврши",
  "desktop.wsl.error.opencodeNotInstalled": "Sente не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.sente.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.sente.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.senteGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Sente",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.senteZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.senteZen.visit.prefix": "Посетете",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Sente.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во sente.json",
  ...
  "dialog.server.description": "Променете на кој Sente сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува Sente во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира Sente во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте Sente во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте Sente во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Sente да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Sente не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на Sente ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Sente",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (sente.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, Sente сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Sente вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Sente во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Sente",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Sente на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Sente ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Sente е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Sente",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Sente.",
