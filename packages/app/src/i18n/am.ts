export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente መጫን አልቻለም",
  "desktop.recovery.terminated": "Sente መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Sente ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Senteመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.senteMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.senteCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.opencodeNotInstalled": "Sente በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Sente ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.sente.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.sente.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.senteGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በSente",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በSente ይጠቀሙ።",
  ...
  "provider.connect.senteZen.line1": "Sente ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.senteZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.senteZen.visit.prefix": "ጎብኝ ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በSente ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በSente ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ sente.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Sente አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Senteን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Sente...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Sente በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Sente በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Sente ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Sente በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Senteአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Sente WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Sente በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Sente።",
  ...
  "help.tabs.introduction": "Sente ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የSente ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለSente ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (sente.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Sente እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Sente ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የSente አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለSente",
  ...
  "settings.general.row.appearance.description": "Senteበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Sente ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Sente ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Sente ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የSente እትም እያሄዱ ነው።",
