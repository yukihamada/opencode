...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Sente įkelti nepavyko",
  "Sente langas netikėtai užsidarė",
  "Sente neatsako",
  ...
  "Sente įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "sente šiame distributyve neįdiegtas",
  "sente įdiegtas, bet jo paleisti nepavyko",
  "Sente neįdiegtas distributyve {{distro}}",
  "Sente naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.sente.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.sente.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.senteGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Sente modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.senteZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.senteZen.visit.prefix": "Aplankykite",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Sente.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti sente.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Sente serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Sente {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Sente {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Sente {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Sente į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Sente galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Sente nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Sente ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Sente komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (sente.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Sente dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Sente apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Sente darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Sente serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Sente ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Sente atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Sente seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Sente temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Sente",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Sente versiją.",
