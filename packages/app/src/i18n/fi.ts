export const dict = {
  ...
  "dialog.provider.sente.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.sente.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.senteGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Senten tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Sentessa.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.senteZen.visit.prefix": "Avaa ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Sentessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Sentessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään sente.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Sente-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Sentea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Sentea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Sentea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Sentea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Sente jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Sente jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sentea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Sente voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Sente ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Sente uudelleen.",
  ...
  "toast.update.description": "Senten uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Sente-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (sente.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Sente ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Sente sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Sente-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Senten näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Sente näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Sente järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Senten teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Sente käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Senten uusinta versiota.",
  ...
  "desktop.menu.documentation": "Sente-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Sente-valikko",
  ...
  "desktop.recovery.loadFailed": "Senten lataaminen epäonnistui",
  "desktop.recovery.terminated": "Sente-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Sente ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Senten asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.senteMissing": "sentea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.senteCannotRun": "sente on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "Sentea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Senten päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Sente Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
