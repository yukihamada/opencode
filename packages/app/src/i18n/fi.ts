export const dict = {
  ...
  "wsl.onboarding.checkingSente": "Tarkistetaan Sentea...",
  "wsl.onboarding.checkingSenteIn": "Tarkistetaan Sentea kohteessa {{distro}}...",
  "wsl.onboarding.updatingSente": "Päivitetään Sentea...",
  "wsl.onboarding.updatingSenteIn": "Päivitetään Sentea kohteessa {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Päivitä Sente jakelussa {{distro}}.",
  "wsl.onboarding.updateSente": "Päivitä Sente",
  "wsl.onboarding.senteReadyIn": "Sente on valmis jakelussa {{distro}}.",
  "wsl.onboarding.senteReady": "Sente on valmis.",
  "wsl.onboarding.installSenteIn": "Asenna Sente jakeluun {{distro}}.",
  "wsl.onboarding.installSente": "Asenna Sente",
  ...
  "desktop.wsl.error.opencodeMissing": "sentea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "sente on asennettu, mutta sitä ei voitu suorittaa",
