export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans sente.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (sente.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Sente ne supporte pas encore l'authentification MCP.",
