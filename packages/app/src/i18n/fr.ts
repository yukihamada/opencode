export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "sente est installé, mais n'a pas pu s'exécuter",
  ...
  "wsl.onboarding.checkingSente": "Vérification d'Sente...",
  "wsl.onboarding.checkingSenteIn": "Vérification d'Sente dans {{distro}}...",
  "wsl.onboarding.updatingSente": "Mise à jour d'Sente...",
  "wsl.onboarding.updatingSenteIn": "Mise à jour d'Sente dans {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Mettez à jour Sente dans {{distro}}.",
  "wsl.onboarding.updateSente": "Mettre à jour Sente",
  "wsl.onboarding.senteReadyIn": "Sente est prêt dans {{distro}}.",
  "wsl.onboarding.senteReady": "Sente est prêt.",
  "wsl.onboarding.installSenteIn": "Installez Sente dans {{distro}}.",
  "wsl.onboarding.installSente": "Installer Sente",
