export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Sente",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Sente",
  "desktop.recovery.terminated": "La fenêtre Sente s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Sente ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Sente",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.senteMissing": "sente n'est pas installé dans cette distribution",
  "desktop.wsl.error.senteCannotRun": "sente est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "Sente n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Sente est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.sente.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.sente.tagline": "Modèles optimisés et fiables",
  "dialog.provider.senteGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Sente",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.senteZen.visit.prefix": "Visitez ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Sente.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans sente.json",
  ...
  "dialog.server.description": "Changez le serveur Sente auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Sente dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Sente dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Sente dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Sente dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Sente puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Sente n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Sente ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Sente",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (sente.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Sente ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Sente inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Sente dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Sente",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Sente sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Sente suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Sente.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Sente",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Sente.",
