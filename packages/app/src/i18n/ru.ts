export const dict = {
  ...
  "desktop.menu.documentation": "Документация Sente",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Sente",
  "desktop.recovery.terminated": "Окно Sente неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Sente не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Sente",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.senteMissing": "sente не установлен в этом дистрибутиве",
  "desktop.wsl.error.senteCannotRun": "sente установлен, но его не удалось запустить",
  "desktop.wsl.error.opencodeNotInstalled": "Sente не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Sente завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.sente.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.sente.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.senteGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Sente",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  "provider.connect.senteZen.line2":
    "С одним ключом API вы получите доступ к таким моделям, как Claude, GPT, Gemini, GLM и другие.",
  "provider.connect.senteZen.visit.prefix": "Посетите ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Sente.",
  ...
  "dialog.plugins.empty": "Плагины настроены в sente.json",
  ...
  "dialog.server.description": "Выберите сервер Sente, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Sente в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Sente в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Sente в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Sente готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Sente в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Sente требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Sente не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Sente.",
  ...
  "help.tabs.introduction": "Теперь работа в Sente Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Sente ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Sente",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (sente.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Sente пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Sente включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Sente внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Sente",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Sente на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Sente системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Sente.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Sente",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Sente.",
