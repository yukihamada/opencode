export const dict = {
  ...
  "dialog.provider.sente.tagline": "Надежные оптимизированные модели",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Sente.",
  ...
  "provider.connect.senteZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.server.description": "Переключите сервер Sente к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Sente требуется WSL (Windows Subsystem for Linux)",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (sente.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Sente пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как Sente выглядит на вашем устройстве",
