export const dict = {
  ...
  "dialog.provider.sente.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.sente.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.senteGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Sente",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.senteZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.senteZen.visit.prefix": "Besøg ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Sente.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i sente.json",
  ...
  "dialog.server.description": "Skift hvilken Sente-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Sente i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Sente i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Sente i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Sente kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Sente kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Sente igen.",
  ...
  "toast.update.description": "En ny version af Sente ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Sente-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (sente.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Sente understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Sente inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Sente-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Sente",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Sente ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Sente skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Sentes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Sente starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Sente.",
  ...
  "desktop.recovery.loadFailed": "Sente kunne ikke indlæses",
  "desktop.recovery.terminated": "Sente-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Sente mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.senteMissing": "sente er ikke installeret i denne distribution",
  "desktop.wsl.error.senteCannotRun": "sente er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "Sente er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Sente er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Sente Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
