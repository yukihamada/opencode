export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "sente مثبت، لكن تعذر تشغيله",
  ...
  "wsl.onboarding.checkingSente": "جارٍ التحقق من Sente...",
  "wsl.onboarding.checkingSenteIn": "جارٍ التحقق من Sente في {{distro}}...",
  "wsl.onboarding.updatingSente": "جارٍ تحديث Sente...",
  "wsl.onboarding.updatingSenteIn": "جارٍ تحديث Sente في {{distro}}...",
  "wsl.onboarding.updateSenteIn": "حدّث Sente في {{distro}}.",
  "wsl.onboarding.updateSente": "تحديث Sente",
  "wsl.onboarding.senteReadyIn": "Sente جاهز في {{distro}}.",
  "wsl.onboarding.senteReady": "Sente جاهز.",
  "wsl.onboarding.installSenteIn": "ثبّت Sente في {{distro}}.",
  "wsl.onboarding.installSente": "تثبيت Sente",
