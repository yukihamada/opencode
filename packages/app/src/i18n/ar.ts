export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Sente.",
  ...
  "toast.update.description": "نسخة جديدة من Sente ({{version}}) متاحة الآن للتثبيت.",
