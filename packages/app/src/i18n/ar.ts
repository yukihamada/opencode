export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Sente",
  "desktop.recovery.terminated": "توقفت نافذة Sente بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Sente لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Sente",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.senteMissing": "sente غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.senteCannotRun": "sente مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "Sente غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Sente، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.sente.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.sente.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.senteGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Sente",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Sente.",
  ...
  "provider.connect.senteZen.line1":
    "يمنحك Sente Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.senteZen.visit.prefix": "قم بزيارة ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Sente.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في sente.json",
  ...
  "dialog.server.description": "تبديل خادم Sente الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Sente...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Sente في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Sente...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Sente في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Sente في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Sente في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Sente من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Sente التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Sente.",
  ...
  "help.tabs.introduction": "أصبح Sente Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Sente ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Sente",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (sente.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Sente لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Sente نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Sente داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Sente",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Sente على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Sente يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Sente.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Sente",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Sente.",
