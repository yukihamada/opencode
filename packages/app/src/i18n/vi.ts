export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Sente",
  ...
  "desktop.recovery.loadFailed": "Không tải được Sente",
  "desktop.recovery.terminated": "Cửa sổ Sente đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Sente không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Sente",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.senteMissing": "sente chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.senteCannotRun": "sente đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.opencodeNotInstalled": "Sente chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Sente nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.sente.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.sente.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.senteGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Sente cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.senteZen.visit.prefix": "Truy cập ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Sente.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong sente.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Sente mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Sente trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Sente trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Sente trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Sente trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Sente có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Sente không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Sente ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Sente",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (sente.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Sente chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Sente bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Sente",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Sente trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Sente tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Sente.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Sente khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Sente.",
