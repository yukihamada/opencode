export const dict = {
  ...
  "desktop.menu.documentation": "Sente Skjøl",
  ...
  "desktop.menu.ariaLabel": "Sente valmynd",
  ...
  "desktop.recovery.loadFailed": "Sente miseydnaðist at heinta",
  "desktop.recovery.terminated": "Sente vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Sente svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Sente uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.senteMissing": "sente er ikki sett upp í hesi distro",
  "desktop.wsl.error.senteCannotRun": "sente er sett upp men kundi ikki koyra",
  "desktop.wsl.error.opencodeNotInstalled": "Sente er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.sente.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.sente.tagline": "Álítandi optimerað modell",
  "dialog.provider.senteGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Sente",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.senteZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.senteZen.visit.prefix": "Vitja ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Sente.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í sente.json",
  ...
  "dialog.server.description": "Skift hvønn Sente ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Sente í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Sente í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Sente í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Sente upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Sente kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Sente kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Sente aftur.",
  ...
  "help.tabs.introduction": "Sente Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Sente ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Sente toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (sente.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Sente stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Sente inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Sente Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Sente ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Sente",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Sente sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Sente fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Sente er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Sente byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Sente.",
