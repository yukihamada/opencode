export const dict = {
  ...
  "desktop.menu.documentation": "Sente-documentatie",
  ...
  "desktop.recovery.loadFailed": "Sente kan niet worden geladen",
  "desktop.recovery.terminated": "Het Sente-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Sente reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Sente is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.senteMissing": "sente is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.senteCannotRun": "sente is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "Sente is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Sente-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.sente.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.sente.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.senteGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Sente",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Sente te gebruiken.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.senteZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.senteZen.visit.prefix": "Ga naar ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Sente te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Sente te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in sente.json",
  ...
  "dialog.server.description": "Wijzig met welke Sente-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Sente controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sente bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Sente bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Sente bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Sente bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Sente is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Sente in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Sente een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Sente kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Sente opnieuw.",
  ...
  "help.tabs.introduction": "Sente Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Sente ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Sente-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (sente.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Sente ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Sente bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Sente-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Sente",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Sente eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Sente het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Sente aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Sente wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Sente is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Sente.",
