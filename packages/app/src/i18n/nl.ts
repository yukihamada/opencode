export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "sente is geïnstalleerd, maar kan niet worden uitgevoerd",
  ...
  "wsl.onboarding.checkingSente": "Sente controleren...",
  "wsl.onboarding.checkingSenteIn": "Sente controleren in {{distro}}...",
  "wsl.onboarding.updatingSente": "Sente bijwerken...",
  "wsl.onboarding.updatingSenteIn": "Sente bijwerken in {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Werk Sente bij in {{distro}}.",
  "wsl.onboarding.updateSente": "Sente bijwerken",
  "wsl.onboarding.senteReadyIn": "Sente is gereed in {{distro}}.",
  "wsl.onboarding.senteReady": "Sente is klaar.",
  "wsl.onboarding.installSenteIn": "Installeer Sente in {{distro}}.",
  "wsl.onboarding.installSente": "Installeer Sente",
