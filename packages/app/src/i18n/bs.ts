export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Sente",
  ...
  "desktop.menu.ariaLabel": "Sente meni",
  ...
  "desktop.recovery.loadFailed": "Sente se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Sente-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Sente ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Sente-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.senteMissing": "sente nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.senteCannotRun": "sente je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "Sente nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Sente-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.sente.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.sente.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.senteGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Sente",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Sente-u.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.senteZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.senteZen.visit.prefix": "Posjeti ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Sente-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Sente-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u sente.json",
  ...
  "dialog.server.description": "Promijeni na koji se Sente server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Sente u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Sente u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Sente u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Sente u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Sente mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Sente nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Sente-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Sente timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (sente.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Sente još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Sente uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Sente server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Sente-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Sente izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Sente prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Sente-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Sente pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Sente-a.",
