export const dict = {
  ...
  "dialog.provider.sente.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.sente.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.senteGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Sente",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.senteZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.senteZen.visit.prefix": "Visita ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Sente.",
  ...
  "dialog.plugins.empty": "Plugin configurati in sente.json",
  ...
  "dialog.server.description": "Cambia il server Sente a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Sente in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Sente in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Sente in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Sente in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Sente possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Sente non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Sente ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Sente",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (sente.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Sente non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Sente all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Sente",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Sente sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Sente segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Sente.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Sente",
  ...
  "settings.updates.toast.latest.title": "Sente è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Sente.",
  ...
  "desktop.menu.documentation": "Documentazione di Sente",
  ...
  "desktop.menu.ariaLabel": "Menu Sente",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Sente",
  "desktop.recovery.terminated": "La finestra di Sente si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Sente non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Sente non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.senteMissing": "sente non è installato in questa distribuzione",
  "desktop.wsl.error.senteCannotRun": "sente è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "Sente non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Sente è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
