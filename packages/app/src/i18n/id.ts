export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente gagal dimuat",
  "desktop.recovery.terminated": "Jendela Sente berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Sente tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Sente gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.senteMissing": "sente belum terinstal di distro ini",
  "desktop.wsl.error.senteCannotRun": "sente telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Sente belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Sente selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.sente.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.sente.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.senteGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Sente",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.senteZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Sente.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di sente.json",
  ...
  "dialog.server.description": "Ganti server Sente mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Sente di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Sente di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Sente di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Sente di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Sente dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Sente tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Sente ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Sente",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (sente.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Sente belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Sente di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Sente",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Sente di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Sente mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Sente diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Sente.",
