export const dict = {
  ...
  "desktop.menu.documentation": "Sente Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Sente.",
  ...
  "desktop.recovery.loadFailed": "Sente no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Sente s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Sente no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Sente ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.senteMissing": "sente no està instal·lat en aquesta distribució",
  "desktop.wsl.error.senteCannotRun": "sente està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.opencodeNotInstalled": "Sente no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.sente.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.sente.tagline": "Models optimitzats fiables",
  "dialog.provider.senteGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Sente",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.senteZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Sente.",
  ...
  "dialog.plugins.empty": "Connectors configurats a sente.json",
  ...
  "dialog.server.description": "Canvia a quin Sente servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Sente...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Sente a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Sente...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Sente a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Sente a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Sente a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Sente pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Sente no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Sente.",
  ...
  "help.tabs.introduction": "Sente L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Sente ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Sente.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (sente.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Sente encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Sente Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Sente dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Sente",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Sente al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Sente segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Sente.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Sente.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Sente.",
