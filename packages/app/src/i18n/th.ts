export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "ไม่ได้ติดตั้ง sente ในดิสโทรนี้",
  "desktop.wsl.error.opencodeCannotRun": "ติดตั้ง sente แล้ว แต่ไม่สามารถเรียกใช้ได้",
  ...
  "wsl.onboarding.checkingSente": "กำลังตรวจสอบ Sente...",
  "wsl.onboarding.checkingSenteIn": "กำลังตรวจสอบ Sente ใน {{distro}}...",
  "wsl.onboarding.updatingSente": "กำลังอัปเดต Sente...",
  "wsl.onboarding.updatingSenteIn": "กำลังอัปเดต Sente ใน {{distro}}...",
  "wsl.onboarding.updateSenteIn": "อัปเดต Sente ใน {{distro}}",
  "wsl.onboarding.updateSente": "อัปเดต Sente",
  "wsl.onboarding.senteReadyIn": "Sente พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.senteReady": "Sente พร้อมใช้งานแล้ว",
  "wsl.onboarding.installSenteIn": "ติดตั้ง Sente ใน {{distro}}",
  "wsl.onboarding.installSente": "ติดตั้ง Sente",
