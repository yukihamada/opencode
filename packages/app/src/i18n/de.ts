...
export const dict = {
  ...
  "wsl.onboarding.checkingSente": "Sente wird geprüft…",
  "wsl.onboarding.checkingSenteIn": "Sente in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingSente": "Sente wird aktualisiert…",
  "wsl.onboarding.updatingSenteIn": "Sente in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateSenteIn": "Aktualisieren Sie Sente in {{distro}}.",
  "wsl.onboarding.updateSente": "Sente aktualisieren",
  "wsl.onboarding.senteReadyIn": "Sente ist in {{distro}} bereit.",
  "wsl.onboarding.senteReady": "Sente ist bereit.",
  "wsl.onboarding.installSenteIn": "Installieren Sie Sente in {{distro}}.",
  "wsl.onboarding.installSente": "Sente installieren",
  ...
  "desktop.wsl.error.opencodeMissing": "sente ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "sente ist installiert, konnte aber nicht ausgeführt werden",
