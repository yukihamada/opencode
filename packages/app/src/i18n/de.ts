...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Sente zu nutzen.",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (sente.json) auf Anbieter-/Modellnamen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Sente.",
