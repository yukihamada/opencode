...
export const dict = {
  ...
  "dialog.provider.sente.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.sente.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.senteGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Sente",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Sente zu nutzen.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.senteZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Sente zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Sente zu nutzen.",
  ...
  "dialog.plugins.empty": "In sente.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Sente-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Sente wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Sente in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Sente wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Sente in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Sente in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Sente aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Sente ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Sente ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Sente in {{distro}}.",
  "wsl.onboarding.installOpencode": "Sente installieren",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Sente einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Sente konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Sente erneut.",
  ...
  "toast.update.description": "Eine neue Version von Sente ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Sente-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (sente.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Sente unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Sente mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Sente enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Sente Desktop",
  ...
  "settings.desktop.wsl.description": "Sente-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Sente ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Sente auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Sente dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Sente anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Sente automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Sente ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Sente wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Sente konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Sente-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Sente reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Sente-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.senteMissing": "sente ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.senteCannotRun": "sente ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "Sente ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Sente-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Sente Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
