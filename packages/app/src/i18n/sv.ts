export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente kunde inte läsas in",
  "desktop.recovery.terminated": "Sente-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Sente svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Sente misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.senteMissing": "sente är inte installerat i den här distributionen",
  "desktop.wsl.error.senteCannotRun": "sente är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "Sente är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.sente.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.sente.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.senteGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Sente",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.senteZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.senteZen.visit.prefix": "Besök ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Sente.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i sente.json",
  ...
  "dialog.server.description": "Växla vilken Sente-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Sente i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Sente i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Sente i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Sente i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Sente kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Sente kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Sente igen.",
  ...
  "help.tabs.introduction": "Sente Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Sente ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Sente-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (sente.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Sente stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Sente innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Sente-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Sente",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Sente ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Sente följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Sentes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Sente startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Sente.",
