export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Sente",
  ...
  "desktop.menu.ariaLabel": "Meniu Sente",
  ...
  "desktop.recovery.loadFailed": "Sente nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Sente s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Sente nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Sente a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.senteMissing": "sente nu este instalat în această distribuție",
  "desktop.wsl.error.senteCannotRun": "sente este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.opencodeNotInstalled": "Sente nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Sente s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.sente.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.sente.tagline": "Modele optimizate, fiabile",
  "dialog.provider.senteGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Sente",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.senteZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.senteZen.visit.prefix": "Vizitează",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Sente.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în sente.json",
  ...
  "dialog.server.description": "Schimbă serverul Sente la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Sente în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Sente în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Sente în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Sente în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Sente să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Sente nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Sente ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Sente",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (sente.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Sente nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Sente în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Sente",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Sente pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Sente urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Sente.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Sente",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Sente.",
