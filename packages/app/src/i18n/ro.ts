export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "sente nu este instalat în această distribuție",
  "desktop.wsl.error.opencodeCannotRun": "sente este instalat, dar nu a putut fi pornit",
  ...
  "wsl.onboarding.checkingSente": "Se verifică Sente...",
  "wsl.onboarding.checkingSenteIn": "Se verifică Sente în {{distro}}...",
  "wsl.onboarding.updatingSente": "Se actualizează Sente...",
  "wsl.onboarding.updatingSenteIn": "Se actualizează Sente în {{distro}}...",
  "wsl.onboarding.updateSenteIn": "Actualizează Sente în {{distro}}.",
  "wsl.onboarding.updateSente": "Actualizează Sente",
  "wsl.onboarding.senteReadyIn": "Sente este gata în {{distro}}.",
  "wsl.onboarding.senteReady": "Sente este gata.",
  "wsl.onboarding.installSenteIn": "Instalează Sente în {{distro}}.",
  "wsl.onboarding.installSente": "Instalează Sente",
