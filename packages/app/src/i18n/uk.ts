export const dict = {
  ...
  "desktop.menu.documentation": "Документація Sente",
  ...
  "desktop.menu.ariaLabel": "Меню Sente",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Sente",
  "desktop.recovery.terminated": "Роботу вікна Sente несподівано завершено",
  "desktop.recovery.unresponsive": "Sente не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Sente",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.senteMissing": "sente не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.senteCannotRun": "sente встановлено, але його не вдалося запустити",
  "desktop.wsl.error.opencodeNotInstalled": "Sente не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Sente завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.sente.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.sente.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.senteGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Sente",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.senteZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.senteZen.visit.prefix": "Відвідайте ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Sente.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в sente.json",
  ...
  "dialog.server.description": "Перемкніть сервер Sente, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Sente у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Sente у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Sente у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Sente у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Sente потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Sente не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Sente.",
  ...
  "help.tabs.introduction": "Sente Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Sente ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Sente",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (sente.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Sente ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Sente всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Sente",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Sente на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Sente використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Sente.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Sente",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Sente.",
