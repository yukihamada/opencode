export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں sente انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "sente انسٹال ہے لیکن چل نہیں سکا",
  ...
  "wsl.onboarding.checkingSente": "Sente چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingSenteIn": "{{distro}} میں Sente چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingSente": "Sente کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingSenteIn": "{{distro}} میں Sente کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateSenteIn": "{{distro}} میں Sente کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateSente": "Sente کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.senteReadyIn": "Sente {{distro}} میں تیار ہے۔",
  "wsl.onboarding.senteReady": "Sente تیار ہے۔",
  "wsl.onboarding.installSenteIn": "{{distro}} میں Sente انسٹال کریں۔",
  "wsl.onboarding.installSente": "Sente انسٹال کریں۔",
