export const dict = {
  ...
  "desktop.menu.documentation": "Sente دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Sente مینو",
  ...
  "desktop.recovery.loadFailed": "Sente لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Sente ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Sente جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Sente کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.senteMissing": "sente انسٹال نہیں ہے",
  "desktop.wsl.error.senteCannotRun": "sente انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Sente انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Sente کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.sente.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.sente.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.senteGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Sente میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.senteZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.senteZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Sente میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Sente میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "sente.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Sente سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Sente چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Sente چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Sente کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Sente کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Sente کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Sente کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Sente {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Sente تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Sente انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Sente انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Sente WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Sente اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Sente کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Sente Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Sente ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (sente.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Sente ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Sente میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Sente ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Sente سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Sente کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Sente کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Sente سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Sente کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Sente لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Sente کا تازہ ترین ورژن چلا رہے ہیں۔",
