export const dict = {
  ...
  "desktop.menu.documentation": "Sente Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Sente",
  ...
  "desktop.recovery.loadFailed": "Sente se nepodařilo načíst",
  "desktop.recovery.terminated": "Sente okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Sente nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Sente instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.senteMissing": "sente není v této distribuci nainstalováno",
  "desktop.wsl.error.senteCannotRun": "sente je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "Sente není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Sente aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.sente.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.sente.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.senteGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Sente.",
  ...
  "provider.connect.senteZen.line1":
    "Sente Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.senteZen.visit.prefix": "Návštěva ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Sente.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Sente.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v sente.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Sente serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Sente...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Sente v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Sente...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Sente v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Sente v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Sente",
  "wsl.onboarding.opencodeReadyIn": "Sente je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Sente je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Sente do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "Sente není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Sente může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Sente nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Sente.",
  ...
  "help.tabs.introduction": "Sente Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Sente ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Sente",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (sente.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Sente zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Sente obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Sente uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Sente",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Sente na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Sente následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Sente.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Sente",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Sente.",
