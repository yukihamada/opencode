...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sente 載入失敗",
  "desktop.recovery.terminated": "Sente 視窗意外終止",
  "desktop.recovery.unresponsive": "Sente 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Sente 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.senteMissing": "sente",
  "desktop.wsl.error.senteCannotRun": "sente，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Sente",
  "desktop.wsl.error.updateVersion":
    "Sente 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.sente.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.sente.tagline": "經過最佳化的可靠模型",
  "dialog.provider.senteGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Sente 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Sente 中使用 {{provider}} 模型。",
  ...
  "provider.connect.senteZen.line1": "Sente Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.senteZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.senteZen.visit.prefix": "造訪 ",
  "provider.connect.senteZen.visit.link": "teai.io/sente/zen",
  "provider.connect.senteZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Sente 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Sente 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 sente.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Sente 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Sente...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Sente...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Sente 已就緒。",
  "wsl.onboarding.opencodeReady": "Sente 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Sente。",
  "wsl.onboarding.installOpencode": "安裝 Sente",
  ...
  "wsl.onboarding.distroStatus.senteMissing": "未安裝 Sente",
  ...
  "wsl.onboarding.wslUnavailable.description": "Sente 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Sente。",
  ...
  "help.tabs.introduction": "Sente Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sente 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Sente 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (sente.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Sente 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Sente 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Sente 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Sente 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Sente 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Sente 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Sente 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Sente 啟動時自動檢查更新",
