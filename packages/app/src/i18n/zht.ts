...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 sente",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 sente，但無法執行",
  ...
  "wsl.onboarding.checkingSente": "正在檢查 Sente...",
  "wsl.onboarding.checkingSenteIn": "正在檢查 {{distro}} 中的 Sente...",
  ...
  "wsl.onboarding.senteReadyIn": "{{distro}} 中的 Sente 已就緒。",
  "wsl.onboarding.senteReady": "Sente 已就緒。",
  "wsl.onboarding.installSenteIn": "在 {{distro}} 中安裝 Sente。",
  "wsl.onboarding.installSente": "安裝 Sente",
