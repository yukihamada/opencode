...
import { showToast } from "@sente-ai/ui/toast"
...
import { LoaderV2 } from "@sente-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@sente-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-sente") {
      await run(() => api.installSente(distro))
      return
    }
