...
export type WslJob =
  ...
  | { kind: "install-sente"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  senteChecks: Record<string, WslSenteCheck>
...
export type WslServersPlatform = {
  ...
  installSente(name: string): Promise<void>
