...
beforeAll(async () => {
  ...
  mock.module("@sente-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@sente-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@sente-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@sente-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
