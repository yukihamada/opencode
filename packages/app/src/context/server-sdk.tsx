import type { SenteEvent } from "@sente-ai/client/promise"
import type { Event } from "@sente-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: SenteEvent }
...
export function adaptServerEvent(event: SenteEvent): ServerEvent {
...
function currentDelta(event: SenteEvent | undefined): CurrentDelta | undefined {
  if (
