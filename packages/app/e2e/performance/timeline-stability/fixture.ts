...
export const directory = "C:/Sente/TimelineStability"
...
export const model = { providerID: "sente", modelID: "claude-opus-4-6", variant: "max" }
...
export async function setupTimeline(
  ...
  if (input.locale) {
    await page.addInitScript((locale) => {
      localStorage.setItem("sente.global.dat:language", JSON.stringify({ locale }))
    }, input.locale)
  }
