...
- Effect plugins import `@sente-ai/plugin/v2/effect`, not `@sente-ai/core`.
- Public domain values use generated `@sente-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@sente-ai/plugin/v2/effect`.
