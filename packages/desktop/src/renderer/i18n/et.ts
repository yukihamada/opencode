export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Sente uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Sente'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „sente” kasutamiseks taaskäivitage terminal.",
