export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Sente",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Sente is gedownload. Wil je deze installeren en Sente opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'sente' te gebruiken.",
