export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Sente",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Sente е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирајте го терминалот за да ја користите командата „sente“.",
