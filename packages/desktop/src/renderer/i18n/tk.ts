export const dict = {
  ...
  "desktop.updater.none.message": "Sente-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Sente-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'sente' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
