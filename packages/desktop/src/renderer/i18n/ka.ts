export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ Sente-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "Sente-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „sente“ ბრძანების გამოსაყენებლად.",
