export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Sente-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Sente-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'sente' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
