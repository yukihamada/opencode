export const dict = {
  ...
  "desktop.updater.none.message": "Sente'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Sente'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'sente' komutunu kullanmak için terminalinizi yeniden başlatın.",
