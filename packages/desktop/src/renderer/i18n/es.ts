export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Sente",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Sente. ¿Quieres instalarla y reiniciar?",
