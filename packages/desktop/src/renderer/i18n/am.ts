export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የSente ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከSente ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
