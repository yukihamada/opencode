import type { WslDistroProbe, WslSenteCheck, WslServerItem } from "../../preload/types"
...
export function clearWslDistroState(
  ...
  const nextSenteChecks = { ...senteChecks }
  delete nextDistroProbes[distro]
  delete nextSenteChecks[distro]
  return { distroProbes: nextDistroProbes, senteChecks: nextSenteChecks }
}
