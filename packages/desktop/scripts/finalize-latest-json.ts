...
const releaseId = process.env.SENTE_RELEASE
if (!releaseId) throw new Error("SENTE_RELEASE is required")

const version = process.env.SENTE_VERSION
if (!version) throw new Error("SENTE_VERSION is required")
...
const macxTarGz = "sente-desktop-mac-x64.app.tar.gz"
const macaTarGz = "sente-desktop-mac-arm64.app.tar.gz"
