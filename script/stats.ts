...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/sente/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/sente...\n")
...
console.log("Fetching npm all-time downloads for sente-ai...\n")
const npmDownloads = await fetchNpmDownloads("sente-ai")
