...
Generates UPCOMING_CHANGELOG.md by running the sente changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for sente run (default: low)
      --quiet            Suppress sente command output unless it fails
