...
Desktop application and browser-based app issues, including `sente web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core sente server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Sente Zen, Sente Go, and billing issues.
