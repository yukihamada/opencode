...
- PR #10809: https://github.com/anomalyco/sente/pull/10809
- PR #11496: https://github.com/anomalyco/sente/pull/11496

## Do Not Translate (Locale Additions)

- `Sente` (preserve casing in prose; keep `sente` only in commands, package names, paths, or code)
- `Sente CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
