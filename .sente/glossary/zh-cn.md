...
- PR #13942: https://github.com/anomalyco/sente/pull/13942

## Do Not Translate (Locale Additions)

- `Sente` (preserve casing in prose; keep `sente` only when it is part of commands, package names, paths, or code)
- `Sente Zen`
- `Sente CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `sente` in prose when referring to the product name; use `Sente`
