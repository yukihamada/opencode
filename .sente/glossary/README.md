...
Use this folder for locale-specific translation guidance that supplements `.sente/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/sente/pull/12345

## Do Not Translate (Locale Additions)

- `Sente` (preserve casing)
