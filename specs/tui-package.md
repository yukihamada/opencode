...
- Do not replace private `packages/opencode` imports with `@sente-ai/core`
...
- The package has no dependency on `opencode`, `@sente-ai/cli`, or
  `@sente-ai/core`.
...
rg '@sente-ai/core|packages/opencode|packages/cli' packages/tui
