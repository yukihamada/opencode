...
const tableBucketName = `sente-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `sente-${$app.stage}-lake-ingest`,
    destination: "iceberg",
